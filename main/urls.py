...
urlpatterns = [
    path("newssites", views.NewsSites.as_view()),
    path("occasions", views.Occasions.as_view()),
    path("services", views.Services.as_view()),
    path("formatservices", views.FormatServices.as_view()),
    path("rebuildservices", views.RebuildServices.as_view()),
    path("occasions-builder/<sid>", views.OccasionBuilder.as_view()),
    path("occasion-services", views.OccasionServices.as_view()),
    ...
    path("news-services", views.GBuilderNews.as_view()),
    path("news-services/<ids>", views.GBuilderNews.as_view()),
    path("news-sub-services", views.NewsSubServices.as_view()),
    ...
    path("categories/<id>", views.Categories.as_view()),
    path("news-categories", views.NewsCategories.as_view()),
    ...
    path("gbuilder-rebuild/<id>", views.GBuilderRebuild.as_view()),
    path("gbuilder-format/<id>", views.GBuilderFormat.as_view()),
